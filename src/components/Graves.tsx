...
export function Graves() {
    const { size, minRadius } = useControls('graves', { size: 200, minRadius: { value: 6, min: 6, max: 12 } })
    const textureProps = useTexture({ map: 'textures/grave/color.jpg', roughnessMap: 'textures/grave/roughness.jpg' })
    return (
